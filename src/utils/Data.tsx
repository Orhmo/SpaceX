...
const Blob = [
...

  {
    src: Two,
    style:
      'bg-[#E1F3FF] border-[#B3E2FE] border-[1px] rounded-2xl pt-[9px] overflow-hidden w-[100px] h-[65px]',
...

  {
    src: Three,
    style:
      'bg-[#FEF7E1] border-[#FDEDBE] border-[1px] rounded-2xl pt-[7px] overflow-hidden w-[100px] h-[65px] ',
